...
<IMG SRC="https://2265205110-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/spaces%2F-LOuzrzA9qdsjWfu2rC9%2Favatar.png?generation=1539700818190990&alt=media" ALIGN="left" width="70" height="70" />The Shadow system is an apprenticeship model. Shadows on the release team work under the team leads and learn the different roles performed by the team during a release cycle. I have served as a Release Notes Shadow for v1.23 & v1.24 and as an Enhancements shadow for v1.25.
